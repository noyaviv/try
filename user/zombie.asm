...
main(void)
{
  ...
  if(fork() > 0)
   ...
   c:	2e4080e7          	jalr	740(ra) # 2ec <fork>
  10:	00a04763          	bgtz	a0,1e <main+0x1e>
    sleep(5);  // Let child exit before parent.
  exit(0);
  14:	4501                	li	a0,0
  16:	00000097          	auipc	ra,0x0
  1a:	2de080e7          	jalr	734(ra) # 2f4 <exit>
    sleep(5);  // Let child exit before parent.
  1e:	4515                	li	a0,5
  20:	00000097          	auipc	ra,0x0
  24:	364080e7          	jalr	868(ra) # 384 <sleep>
...
gets(char *buf, int max)
{
 ...
 118:	1f8080e7          	jalr	504(ra) # 30c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 16a:	1ce080e7          	jalr	462(ra) # 334 <open>
  if(fd < 0)
 ...
 17a:	1d6080e7          	jalr	470(ra) # 34c <fstat>
 17e:	892a                	mv	s2,a0
  close(fd);
 180:	8526                	mv	a0,s1
 182:	00000097          	auipc	ra,0x0
 186:	19a080e7          	jalr	410(ra) # 31c <close>
  return r;
}
 18a:	854a                	mv	a0,s2
...
char* my_strcat(char* destination, const char* source)
{
 ...
 29a:	c7a9                	beqz	a5,2e4 <my_strcat+0x54>
 29c:	00150713          	addi	a4,a0,1
 2a0:	87ba                	mv	a5,a4
 2a2:	4685                	li	a3,1
 2a4:	9e99                	subw	a3,a3,a4
 2a6:	00f6863b          	addw	a2,a3,a5
 2aa:	0785                	addi	a5,a5,1
 2ac:	fff7c703          	lbu	a4,-1(a5)
 2b0:	fb7d                	bnez	a4,2a6 <my_strcat+0x16>
 ...
 2b6:	ca8d                	beqz	a3,2e8 <my_strcat+0x58>
 2b8:	4785                	li	a5,1
        destination[i + j] = source[j];
 2ba:	00f60733          	add	a4,a2,a5
 2be:	972a                	add	a4,a4,a0
 2c0:	fed70fa3          	sb	a3,-1(a4)
    for (j = 0; source[j] != '\0'; j++)
 2c4:	0007881b          	sext.w	a6,a5
 2c8:	0785                	addi	a5,a5,1
 2ca:	00f58733          	add	a4,a1,a5
 2ce:	fff74683          	lbu	a3,-1(a4)
 2d2:	f6e5                	bnez	a3,2ba <my_strcat+0x2a>
 
    // null terminate destination string
    destination[i + j] = '\0';
 2d4:	0106063b          	addw	a2,a2,a6
 2d8:	962a                	add	a2,a2,a0
 2da:	00060023          	sb	zero,0(a2)
 ...
 2e2:	8082                	ret
    for (i = 0; destination[i] != '\0'; i++);
 2e4:	4601                	li	a2,0
 2e6:	b7f1                	j	2b2 <my_strcat+0x22>
    for (j = 0; source[j] != '\0'; j++)
 2e8:	4801                	li	a6,0
 2ea:	b7ed                	j	2d4 <my_strcat+0x44>
...
malloc(uint nbytes)
{
 ...
 7c6:	06a73f23          	sd	a0,126(a4) # 840 <freep>
      return (void*)(p + 1);
 ...
 814:	b6c080e7          	jalr	-1172(ra) # 37c <sbrk>
  if(p == (char*)-1)
