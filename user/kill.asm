...
main(int argc, char **argv)
{
  ...
  34:	32e080e7          	jalr	814(ra) # 35e <kill>
  for(i=1; i<argc; i++)
  ...
  44:	2ee080e7          	jalr	750(ra) # 32e <exit>
    fprintf(2, "usage: kill pid...\n");
  ...
  60:	2d2080e7          	jalr	722(ra) # 32e <exit>
...
gets(char *buf, int max)
{
 ...
 152:	1f8080e7          	jalr	504(ra) # 346 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a4:	1ce080e7          	jalr	462(ra) # 36e <open>
  if(fd < 0)
 ...
 1b4:	1d6080e7          	jalr	470(ra) # 386 <fstat>
 1b8:	892a                	mv	s2,a0
  close(fd);
 1ba:	8526                	mv	a0,s1
 1bc:	00000097          	auipc	ra,0x0
 1c0:	19a080e7          	jalr	410(ra) # 356 <close>
  return r;
}
 1c4:	854a                	mv	a0,s2
...
char* my_strcat(char* destination, const char* source)
{
 ...
 2d4:	c7a9                	beqz	a5,31e <my_strcat+0x54>
 2d6:	00150713          	addi	a4,a0,1
 2da:	87ba                	mv	a5,a4
 2dc:	4685                	li	a3,1
 2de:	9e99                	subw	a3,a3,a4
 2e0:	00f6863b          	addw	a2,a3,a5
 2e4:	0785                	addi	a5,a5,1
 2e6:	fff7c703          	lbu	a4,-1(a5)
 2ea:	fb7d                	bnez	a4,2e0 <my_strcat+0x16>
 ...
 2f0:	ca8d                	beqz	a3,322 <my_strcat+0x58>
 2f2:	4785                	li	a5,1
        destination[i + j] = source[j];
 2f4:	00f60733          	add	a4,a2,a5
 2f8:	972a                	add	a4,a4,a0
 2fa:	fed70fa3          	sb	a3,-1(a4)
    for (j = 0; source[j] != '\0'; j++)
 2fe:	0007881b          	sext.w	a6,a5
 302:	0785                	addi	a5,a5,1
 304:	00f58733          	add	a4,a1,a5
 308:	fff74683          	lbu	a3,-1(a4)
 30c:	f6e5                	bnez	a3,2f4 <my_strcat+0x2a>
 
    // null terminate destination string
    destination[i + j] = '\0';
 30e:	0106063b          	addw	a2,a2,a6
 312:	962a                	add	a2,a2,a0
 314:	00060023          	sb	zero,0(a2)
 ...
 31c:	8082                	ret
    for (i = 0; destination[i] != '\0'; i++);
 31e:	4601                	li	a2,0
 320:	b7f1                	j	2ec <my_strcat+0x22>
    for (j = 0; source[j] != '\0'; j++)
 322:	4801                	li	a6,0
 324:	b7ed                	j	30e <my_strcat+0x44>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 426:	45e50513          	addi	a0,a0,1118 # 880 <digits>
 42a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f2:	392b8b93          	addi	s7,s7,914 # 880 <digits>
 ...
 632:	24a90913          	addi	s2,s2,586 # 878 <malloc+0x104>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6fa:	1a27b783          	ld	a5,418(a5) # 898 <freep>
...
malloc(uint nbytes)
{
 ...
 79c:	10053503          	ld	a0,256(a0) # 898 <freep>
 ...
 7c4:	0d890913          	addi	s2,s2,216 # 898 <freep>
  if(p == (char*)-1)
 7c8:	5afd                	li	s5,-1
 7ca:	a895                	j	83e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7cc:	00000797          	auipc	a5,0x0
 7d0:	0d478793          	addi	a5,a5,212 # 8a0 <base>
 7d4:	00000717          	auipc	a4,0x0
 7d8:	0cf73223          	sd	a5,196(a4) # 898 <freep>
 7dc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 800:	08a73e23          	sd	a0,156(a4) # 898 <freep>
      return (void*)(p + 1);
