...
main(int argc, char *argv[])
{
  ...
  4c:	326080e7          	jalr	806(ra) # 36e <write>
    if(i + 1 < argc){
  ...
  76:	2fc080e7          	jalr	764(ra) # 36e <write>
    }
  }
  exit(0);
  7a:	4501                	li	a0,0
  7c:	00000097          	auipc	ra,0x0
  80:	2d2080e7          	jalr	722(ra) # 34e <exit>
...
gets(char *buf, int max)
{
 ...
 172:	1f8080e7          	jalr	504(ra) # 366 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1c4:	1ce080e7          	jalr	462(ra) # 38e <open>
  if(fd < 0)
 ...
 1d4:	1d6080e7          	jalr	470(ra) # 3a6 <fstat>
 1d8:	892a                	mv	s2,a0
  close(fd);
 1da:	8526                	mv	a0,s1
 1dc:	00000097          	auipc	ra,0x0
 1e0:	19a080e7          	jalr	410(ra) # 376 <close>
  return r;
}
 1e4:	854a                	mv	a0,s2
...
char* my_strcat(char* destination, const char* source)
{
 ...
 2f4:	c7a9                	beqz	a5,33e <my_strcat+0x54>
 2f6:	00150713          	addi	a4,a0,1
 2fa:	87ba                	mv	a5,a4
 2fc:	4685                	li	a3,1
 2fe:	9e99                	subw	a3,a3,a4
 300:	00f6863b          	addw	a2,a3,a5
 304:	0785                	addi	a5,a5,1
 306:	fff7c703          	lbu	a4,-1(a5)
 30a:	fb7d                	bnez	a4,300 <my_strcat+0x16>
 ...
 310:	ca8d                	beqz	a3,342 <my_strcat+0x58>
 312:	4785                	li	a5,1
        destination[i + j] = source[j];
 314:	00f60733          	add	a4,a2,a5
 318:	972a                	add	a4,a4,a0
 31a:	fed70fa3          	sb	a3,-1(a4)
    for (j = 0; source[j] != '\0'; j++)
 31e:	0007881b          	sext.w	a6,a5
 322:	0785                	addi	a5,a5,1
 324:	00f58733          	add	a4,a1,a5
 328:	fff74683          	lbu	a3,-1(a4)
 32c:	f6e5                	bnez	a3,314 <my_strcat+0x2a>
 
    // null terminate destination string
    destination[i + j] = '\0';
 32e:	0106063b          	addw	a2,a2,a6
 332:	962a                	add	a2,a2,a0
 334:	00060023          	sb	zero,0(a2)
 ...
 33c:	8082                	ret
    for (i = 0; destination[i] != '\0'; i++);
 33e:	4601                	li	a2,0
 340:	b7f1                	j	30c <my_strcat+0x22>
    for (j = 0; source[j] != '\0'; j++)
 342:	4801                	li	a6,0
 344:	b7ed                	j	32e <my_strcat+0x44>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 446:	45650513          	addi	a0,a0,1110 # 898 <digits>
 44a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 512:	38ab8b93          	addi	s7,s7,906 # 898 <digits>
 ...
 652:	24290913          	addi	s2,s2,578 # 890 <malloc+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 71a:	19a7b783          	ld	a5,410(a5) # 8b0 <freep>
...
malloc(uint nbytes)
{
 ...
 7bc:	0f853503          	ld	a0,248(a0) # 8b0 <freep>
 ...
 7e4:	0d090913          	addi	s2,s2,208 # 8b0 <freep>
  if(p == (char*)-1)
 7e8:	5afd                	li	s5,-1
 7ea:	a895                	j	85e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7ec:	00000797          	auipc	a5,0x0
 7f0:	0cc78793          	addi	a5,a5,204 # 8b8 <base>
 7f4:	00000717          	auipc	a4,0x0
 7f8:	0af73e23          	sd	a5,188(a4) # 8b0 <freep>
 7fc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 820:	08a73a23          	sd	a0,148(a4) # 8b0 <freep>
      return (void*)(p + 1);
 ...
 84c:	ec4080e7          	jalr	-316(ra) # 70c <free>
  return freep;
 ...
 86e:	b6c080e7          	jalr	-1172(ra) # 3d6 <sbrk>
  if(p == (char*)-1)
