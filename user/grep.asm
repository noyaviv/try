...
000000000000011a <grep>:
{
 ...
 180:	40c080e7          	jalr	1036(ra) # 588 <write>
 ...
 198:	3ec080e7          	jalr	1004(ra) # 580 <read>
...
00000000000001de <main>:
{
 ...
 21e:	38e080e7          	jalr	910(ra) # 5a8 <open>
 222:	84aa                	mv	s1,a0
 ...
 23a:	35a080e7          	jalr	858(ra) # 590 <close>
  for(i = 2; i < argc; i++){
 ...
 24a:	322080e7          	jalr	802(ra) # 568 <exit>
    fprintf(2, "usage: grep pattern [file ...]\n");
 24e:	00001597          	auipc	a1,0x1
 252:	84a58593          	addi	a1,a1,-1974 # a98 <malloc+0xea>
 256:	4509                	li	a0,2
 258:	00000097          	auipc	ra,0x0
 25c:	66a080e7          	jalr	1642(ra) # 8c2 <fprintf>
    exit(1);
 260:	4505                	li	a0,1
 262:	00000097          	auipc	ra,0x0
 266:	306080e7          	jalr	774(ra) # 568 <exit>
    grep(pattern, 0);
 26a:	4581                	li	a1,0
 26c:	8552                	mv	a0,s4
...
gets(char *buf, int max)
{
 ...
 38c:	1f8080e7          	jalr	504(ra) # 580 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3de:	1ce080e7          	jalr	462(ra) # 5a8 <open>
  if(fd < 0)
 ...
 3ee:	1d6080e7          	jalr	470(ra) # 5c0 <fstat>
 3f2:	892a                	mv	s2,a0
  close(fd);
 3f4:	8526                	mv	a0,s1
 3f6:	00000097          	auipc	ra,0x0
 3fa:	19a080e7          	jalr	410(ra) # 590 <close>
  return r;
}
 3fe:	854a                	mv	a0,s2
...
char* my_strcat(char* destination, const char* source)
{
 ...
 50e:	c7a9                	beqz	a5,558 <my_strcat+0x54>
 510:	00150713          	addi	a4,a0,1
 514:	87ba                	mv	a5,a4
 516:	4685                	li	a3,1
 518:	9e99                	subw	a3,a3,a4
 51a:	00f6863b          	addw	a2,a3,a5
 51e:	0785                	addi	a5,a5,1
 520:	fff7c703          	lbu	a4,-1(a5)
 524:	fb7d                	bnez	a4,51a <my_strcat+0x16>
 ...
 52a:	ca8d                	beqz	a3,55c <my_strcat+0x58>
 52c:	4785                	li	a5,1
        destination[i + j] = source[j];
 52e:	00f60733          	add	a4,a2,a5
 532:	972a                	add	a4,a4,a0
 534:	fed70fa3          	sb	a3,-1(a4)
    for (j = 0; source[j] != '\0'; j++)
 538:	0007881b          	sext.w	a6,a5
 53c:	0785                	addi	a5,a5,1
 53e:	00f58733          	add	a4,a1,a5
 542:	fff74683          	lbu	a3,-1(a4)
 546:	f6e5                	bnez	a3,52e <my_strcat+0x2a>
 
    // null terminate destination string
    destination[i + j] = '\0';
 548:	0106063b          	addw	a2,a2,a6
 54c:	962a                	add	a2,a2,a0
 54e:	00060023          	sb	zero,0(a2)
 ...
 556:	8082                	ret
    for (i = 0; destination[i] != '\0'; i++);
 558:	4601                	li	a2,0
 55a:	b7f1                	j	526 <my_strcat+0x22>
    for (j = 0; source[j] != '\0'; j++)
 55c:	4801                	li	a6,0
 55e:	b7ed                	j	548 <my_strcat+0x44>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 660:	47c50513          	addi	a0,a0,1148 # ad8 <digits>
 664:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72c:	3b0b8b93          	addi	s7,s7,944 # ad8 <digits>
 ...
 86c:	26890913          	addi	s2,s2,616 # ad0 <malloc+0x122>
        while(*s != 0){
...
free(void *ap)
{
 ...
 934:	1c07b783          	ld	a5,448(a5) # af0 <freep>
 ...
 962:	00e6ea63          	bltu	a3,a4,976 <free+0x50>
{
 ...
 9a4:	14f73823          	sd	a5,336(a4) # af0 <freep>
}
 9a8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9d6:	11e53503          	ld	a0,286(a0) # af0 <freep>
 ...
 9fe:	0f690913          	addi	s2,s2,246 # af0 <freep>
  if(p == (char*)-1)
 a02:	5afd                	li	s5,-1
 a04:	a895                	j	a78 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a06:	00000797          	auipc	a5,0x0
 a0a:	4f278793          	addi	a5,a5,1266 # ef8 <base>
 a0e:	00000717          	auipc	a4,0x0
 a12:	0ef73123          	sd	a5,226(a4) # af0 <freep>
 a16:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a3a:	0aa73d23          	sd	a0,186(a4) # af0 <freep>
      return (void*)(p + 1);
 ...
 a88:	b6c080e7          	jalr	-1172(ra) # 5f0 <sbrk>
  if(p == (char*)-1)
